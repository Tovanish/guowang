 ...
 ;(function($,window,document){
 	...
 	var pluginName = 'dialogBox',
 		defaults = {
 			...
 			width: null, //弹出层宽�?
 			height: null,  //弹出层高�?
 			autoSize: true,  //是否自�?�应尺寸,默认自�?�应
 			autoHide: false,  //是否自自动消失，配合time参数共用
 			time: 3000,  //自动消失时间，单位毫�?
 			zIndex: 99999,  //弹出层定位层�?
 			hasMask: false,  //是否显示遮罩�?
 			hasClose: false,  //是否显示关闭按钮
 			hasBtn: false,  //是否显示操作按钮，如取消，确�?
 			confirmValue: null,  //确定按钮文字内容
 			confirm: function(){}, //点击确定后回调函�?
 			cancelValue: null,  //取消按钮文字内容
 			cancel: function(){},  //点击取消后回调函数，默认关闭弹出�?
 			effect: '', //动画效果：fade(默认),newspaper,fall,scaled,flip-horizontal,flip-vertical,sign,
 			type: 'normal', //对话框类型：normal(普�?�对话框),correct(正确/操作成功对话�?),error(错误/警告对话�?)
